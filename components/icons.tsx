...
export const CircularDepIcon = ({ title, ...props }: React.SVGProps<SVGSVGElement> & { title?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        {title && <title>{title}</title>}
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.695v-2.695A8.25 8.25 0 005.166 6.168l-3.181 3.183" />
    </svg>
);

export const AgentIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 6.75a8.25 8.25 0 000 10.5m0-10.5a8.25 8.25 0 0110.5 0m-10.5 0H3m6.75 0v1.5m10.5 0v-1.5m0 0h1.5m-1.5 0a8.25 8.25 0 01-10.5 0m10.5 0v-1.5m-10.5 0v1.5m0 0H3m6.75 0v1.5m0-1.5H12m6 0h1.5m-1.5 0h-1.5m-6 0H9.75m0 0h2.25m-2.25 0V9m2.25 0V9m0 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
    </svg>
);
...
export const LightBulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a11.999 11.999 0 01-4.5 0m4.5 0a11.999 11.999 0 01-4.5 0M9.75 6.75h4.5M9.75 6.75a2.25 2.25 0 01-2.25-2.25V4.5a2.25 2.25 0 012.25-2.25h4.5a2.25 2.25 0 012.25 2.25v.75a2.25 2.25 0 01-2.25 2.25M9.75 6.75L9.75 12m4.5-5.25L14.25 12" />
    </svg>
);
...
export const ExpandIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M20.25 20.25v-4.5m0 4.5h-4.5m4.5 0L15 15m-6 0L3.75 20.25m9.75-9.75L20.25 3.75" />
    </svg>
);
...
export const ChatIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.05 1.05 0 01-1.485 0l-3.72-3.72A2.123 2.123 0 013 14.894V8.511c0-.97.616-1.813 1.5-2.097m16.5 0a2.121 2.121 0 00-2.121-2.121H6.621A2.121 2.121 0 004.5 6.39v8.502" />
    </svg>
);
...
export const GitBranchIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 3v12m0 0a3 3 0 106 0M6 15a3 3 0 116 0m6-12v2.25A4.5 4.5 0 0113.5 9h-3a4.5 4.5 0 01-4.5-4.5V3" />
    </svg>
);
...
export const CpuChipIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M15.75 3v1.5m0 16.5v-1.5m3.75-12H21m-18 0h1.5m15 3.75H21m-18 0h1.5m9-15v1.5m0 16.5v-1.5M12 8.25h-1.5m1.5 0h1.5m-1.5 3.75h-1.5m1.5 0h1.5m-1.5 3.75h-1.5m1.5 0h1.5M7.5 12h1.5m-1.5 0H6" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);

export const DatabaseStackIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 21v-5.25m0 0a7.5 7.5 0 0010.5 0M17.25 21v-5.25" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 21v-5.25a7.5 7.5 0 0110.5 0m-10.5 0L12 15.75m0 0L17.25 15.75M12 15.75V21m6-6.75v-5.25m0 0a7.5 7.5 0 00-10.5 0M17.25 9V3.75" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 9V3.75m0 5.25a7.5 7.5 0 0110.5 0M6.75 9L12 3.75m0 0L17.25 9" />
    </svg>
);
...
export const UserGroupIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.57-1.03-.09-2.3-1.09-2.3H5.25c-1.121 0-2.028.986-1.928 2.118a9.083 9.083 0 003.741.479 3 3 0 004.682-2.72m-7.5-2.962h.008v.008H10.5v-.008zM10.5 12a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12a7.5 7.5 0 11-15 0 7.5 7.5 0 0115 0zm-12 5.25v-1.5a2.25 2.25 0 012.25-2.25h3a2.25 2.25 0 012.25 2.25v1.5" />
    </svg>
);
...
export const MicrophoneIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m12 5.25v-1.5a6 6 0 00-12 0v1.5m6 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a3 3 0 01-3-3v-1.5a3 3 0 016 0v1.5a3 3 0 01-3 3z" />
    </svg>
);
